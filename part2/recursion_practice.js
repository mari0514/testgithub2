...
console.log("NEED TO WOEK ON THIS LATER");
...
/* Question 5 */
console.log("----- 5. productOfArray -----");
console.log("NEED TO THINK ABOUT THIS");
function productOfArray(arr) {
  if (arr.length === 0) return 1;
  return arr.shift() * productOfArray(arr);
}
console.log(productOfArray([1, 2, 3, 4]));
console.log(productOfArray([2, 4, 6]));
...
/* Question 6 */
console.log("----- 6. Search JS object -----");
console.log("WIP");
